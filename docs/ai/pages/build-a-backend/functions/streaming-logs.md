...
gen: 2
last-updated: "2025-02-25T21:44:20.000Z"
url: "https://docs.amplify.aws/react/build-a-backend/functions/streaming-logs/"
---
...
> **Info:** **注釈**: この機能は [Sandbox](/[platform]/deploy-and-host/sandbox-environments/) でのみ利用可能です
...
> **Info:** 5 個以上の関数を使用する場合は、`--logs-filter` フラグを使用して、ログ出力を特定の関数にフィルタリングすることをお勧めします。
