...
gen: 2
last-updated: "2024-10-07T19:55:17.000Z"
url: "https://docs.amplify.aws/react/build-a-backend/storage/lambda-triggers/"
---
...
> **Info:** **注:** `S3Handler` 型は [`@types/aws-lambda`](https://www.npmjs.com/package/@types/aws-lambda) npm パッケージから提供されます。このパッケージには、異なる種類の Lambda ハンドラー、イベント、レスポンスの型が含まれています。
