...
url: "https://docs.amplify.aws/react/develop-with-ai/mcp-server/amplify-workflows/"
---
...
<details><summary>認証 (Auth)</summary>
...
<details><summary>データ モデリング (Data)</summary>
...
<details><summary>ファイル ストレージ (Storage)</summary>
...
<details><summary>サーバーレス関数 (Functions)</summary>
...
<details><summary>AI 機能 (AI)</summary>
...
<details><summary>React と Next.js</summary>
...
<details><summary>Vue と Angular</summary>
...
<details><summary>React Native</summary>
...
<details><summary>Swift (iOS)</summary>
...
<details><summary>Android (Kotlin)</summary>
...
> **Info:** **要件について具体的に説明してください。** 「認証を追加」ではなく、「メール サインイン、Google ソーシャル ログイン、MFA を使用した認証を追加」と試してください。
...
<details><summary>Amazon Kiro (IDE/CLI)</summary>
...
<details><summary>Claude (Code/Desktop)</summary>
