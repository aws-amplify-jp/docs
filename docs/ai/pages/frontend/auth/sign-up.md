...
<!-- Platform: react -->
> **Info:** Amplify Authをフロントエンドアプリケーションで最も簡単に始める方法は、[Authenticatorコンポーネント](https://ui.docs.amplify.aws/react/connected-components/authenticator)を使用することです。このコンポーネントはカスタマイズ可能なUIと完全な認証フローを提供します。
<!-- /Platform -->

<!-- Platform: swift -->
> **Info:** Amplify Authをフロントエンドアプリケーションで最も簡単に始める方法は、[Authenticatorコンポーネント](https://ui.docs.amplify.aws/swift/connected-components/authenticator)を使用することです。このコンポーネントはカスタマイズ可能なUIと完全な認証フローを提供します。
<!-- /Platform -->

<!-- Platform: flutter -->
> **Info:** Amplify Authをフロントエンドアプリケーションで最も簡単に始める方法は、[Authenticatorコンポーネント](https://ui.docs.amplify.aws/flutter/connected-components/authenticator)を使用することです。このコンポーネントはカスタマイズ可能なUIと完全な認証フローを提供します。
<!-- /Platform -->

<!-- Platform: android -->
> **Info:** Amplify Authをフロントエンドアプリケーションで最も簡単に始める方法は、[Authenticatorコンポーネント](https://ui.docs.amplify.aws/android/connected-components/authenticator)を使用することです。このコンポーネントはカスタマイズ可能なUIと完全な認証フローを提供します。
<!-- /Platform -->
...
> **Info:** **注：** ユーザーがサインインする方法として `email` または `phone` を指定する場合、これらはユーザー名の代わりに使用される属性です。詳細については、[コンセプトページをご覧ください](/[platform]/build-a-backend/auth/concepts/)。
<!-- /Platform -->
