...
```
<details><summary>amplify/data/resources.ts の全体を見る</summary>
...
> **Info:** `npx ampx sandbox` コマンドは `npm run dev` と同時に実行する必要があります。クラウドサンドボックスをアプリバックエンドの「localhost 同等」と考えることができます。
