...
export const meta = {
  title: 'リアルタイムで監視する',
  description: 'DataStore がリアルタイムでデータの変更を処理する方法について詳しく説明します。',
  platforms: [
    'flutter',
    'swift',
    'android',
...
import js3 from '/src/fragments/lib-v1/datastore/native_common/real-time.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/native_common/real-time.mdx';
