...
export const meta = {
  title: 'データの操作',
  description: 'DataStore でデータの保存、クエリ、ページネーション、更新、削除、および監視を行う方法を学びます。',
  platforms: [
    'flutter',
    'swift',
    'android',
...
import js3 from '/src/fragments/lib-v1/datastore/native_common/data-access.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/native_common/data-access.mdx';
