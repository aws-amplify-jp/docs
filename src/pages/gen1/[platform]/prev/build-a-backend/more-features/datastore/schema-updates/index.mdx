...
export const meta = {
  title: 'スキーマの更新',
  description: 'DataStoreのスキーマ更新を発行する方法について詳しく学びます',
  platforms: [
    'flutter',
    'swift',
    'android',
...
import js3 from '/src/fragments/lib-v1/datastore/native_common/schema-updates.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/native_common/schema-updates.mdx';
