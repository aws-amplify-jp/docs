...
export const meta = {
  title: 'データをクラウドに同期',
  description: 'DataStore が AppSync バックエンドに接続し、GraphQL を使用してローカルに保存されたすべてのデータを自動的に同期する方法について詳しく学びます。',
  platforms: [
    'flutter',
    'swift',
    'android',
...
import js3 from '/src/fragments/lib-v1/datastore/native_common/sync.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/native_common/sync.mdx';
