...
export const meta = {
  title: '認可ルールの設定',
  description: '@auth ディレクティブを使用してモデルに認可ルールを適用する方法を学ぶ',
  platforms: [
    'flutter',
    'swift',
    'android',
...
import js3 from '/src/fragments/lib-v1/datastore/native_common/setup-auth-rules.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/native_common/setup-auth-rules.mdx';
