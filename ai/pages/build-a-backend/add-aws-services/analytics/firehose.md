...
> **Warning:** S3 配信先バケットが適切に保護されていることを確認してください。暗号化、アクセス制御、ログについては、[Amazon S3 のセキュリティベストプラクティス](https://docs.aws.amazon.com/AmazonS3/latest/userguide/security-best-practices.html)を参照してください。
